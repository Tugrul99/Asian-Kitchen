...
// Filtre düğmelerine tıklama olayını ekle
let buttons = document.querySelectorAll("button");
buttons.forEach((element) => element.addEventListener("click", filterMenu));
